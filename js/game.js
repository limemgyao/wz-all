                ...
                setTimeout(function(){  
                    $('#NUM .game_coin').each(function(){
                        if($(this).parent().hasClass('on')){
                            ...
                            $(this).animate({'top': '-800%','left': 120 - parleft + 'px',},200);
                        }
                    });
            ...
            var func = function(e){
                ...
                if($(_self).parent().parent().find('.game_choose').find('p').length){
                    $(_self).parent().parent().find('.game_choose').find('p').each(function(){
                        ...
                        $(this).parent().find('b:last').animate({'top': nowbtop + random_t + 'px','left': nowbleft + random_l + 'px','opacity':'1'},100);
                        $(this).remove();
                    });
                }
            }
    ...
    function AjaxGame(sucfunc,errFunc){//获取结果接口
        var data = 1;//Math.random()*10 > 5 ? 1 : 0;
